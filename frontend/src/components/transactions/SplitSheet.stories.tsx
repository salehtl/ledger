...
const cats: Category[] = [
  ...
  { ID: 2, Name: "Transport", Kind: "spending", Bucket: "need", IsActive: true },
  { ID: 3, Name: "Dining", Kind: "spending", Bucket: "want", IsActive: true },
  { ID: 4, Name: "Entertainment", Kind: "spending", Bucket: "want", IsActive: true },
  { ID: 5, Name: "Investments", Kind: "spending", Bucket: "saving", IsActive: true },
  { ID: 6, Name: "Salary", Kind: "income", Bucket: "", IsActive: true },
  { ID: 7, Name: "Transfers", Kind: "excluded", Bucket: "", IsActive: true },
];
