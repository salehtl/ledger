...
const txns: Txn[] = [
  ...
  { ID: 2, PostedAt: "2026-06-09", AmountFils: 2000, AmountAedFils: 2000, Currency: "AED", Direction: "credit", MerchantRaw: "Y", Status: "confirmed", Confidence: 0, Source: "ai", CategoryID: 2, CategoryName: "Dining", Bucket: "want", Kind: "spending", BucketSnapshot: "" },
];
