...
const rows: BreakdownRow[] = [
  { key: "cat:10", name: "Dining", ditherColor: "azure", spent: 680, share: 0.4, delta: 100, deltaPct: 0.17, categoryId: 10 },
  { key: "cat:11", name: "Shopping", ditherColor: "lilac", spent: 560, share: 0.33, delta: -50, deltaPct: -0.08, categoryId: 11 },
];
